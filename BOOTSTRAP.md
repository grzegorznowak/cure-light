...
8. `$RAW_BASE/kernel/references/evidence-format.md`

### Pi driver (notebook + handoff + model-groups binding — only if this runtime provides the pi notebook)

9. `$RAW_BASE/libs/pi-driver/SKILL.md`
10. `$RAW_BASE/libs/pi-driver/references/requirements-check.md`
11. `$RAW_BASE/libs/pi-driver/references/notebook-plan-contract.md`

### Templates / assets (keep for reference during the episode)

12. `$RAW_BASE/templates/KICKOFF.md`
13. `$RAW_BASE/assets/finding-schema.json`
14. `$RAW_BASE/assets/child-pass-prompt-template.md`

### Worked example (optional, read after compiling the process)

15. `$RAW_BASE/docs/example-review.md`
