...
3. **Compile the run frame** to the notebook per `references/notebook-plan-contract.md`: `pipeline-frame-<owner>-<pr>` (frozen options + subject path/OID + base OID) + `pr-<n>-review` (findings skeleton).
